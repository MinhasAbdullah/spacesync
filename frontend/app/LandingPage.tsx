      ...
      <nav className={`landing-nav ${scrolled ? "nav-scrolled" : ""}`}>
        <div className="nav-inner">
          ...
          <ul className="nav-links" id="nav-links">
            {["Features", "Pricing", "Resources", "Blog"].map((link) => (
              <li key={link}>
        ...
        <div className="hero-inner">
          ...
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              ...
              <Link href="#demo" className="btn-outline btn-lg" id="hero-cta-demo">
        ...
        <div className="features-inner">
          ...
          <div className="features-grid">
            <div className="feat-card feat-card-1" id="feat-access">
              ...
              <Link href="#" className="feat-link">Learn more →</Link>
            </div>
        ...
        <div className="pricing-inner">
          ...
          <div className="pricing-grid">
            {[
              ...
              { plan: "Enterprise", price: "Custom", period: "", features: ["Custom deployment", "Dedicated support", "SLA guarantees", "SSO & SAML", "White-label option"], cta: "Contact Sales", featured: false },
      ...
      <section className="cta-section" id="cta">
        ...
        <div className="cta-inner">
          ...
          <div className="cta-buttons">
            ...
            <Link href="#demo" className="btn-ghost btn-lg" id="cta-demo">Book a Demo</Link>
          </div>
        </div>
      </section>
        ...
        <div className="footer-inner">
          ...
          <div className="footer-links-grid">
            {[
              ...
              { heading: "Resources", links: ["Documentation", "API Docs", "Status", "Community"] },
              ...
              <div key={heading} className="footer-col">
                ...
                <ul className="footer-col-links">
                  {links.map((l) => (
                    <li key={l}><Link href="#" className="footer-link">{l}</Link></li>
                  ))}
                </ul>
              </div>
            ))}
        ...
        <div className="footer-bottom">
          ...
          <div className="social-links">
            {["Twitter", "LinkedIn", "GitHub"].map((s) => (
              <Link key={s} href="#" className="social-link" id={`social-${s.toLowerCase()}`}>{s}</Link>
            ))}
          </div>
        </div>
      </footer>
