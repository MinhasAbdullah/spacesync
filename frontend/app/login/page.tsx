        ...
        <main className="content-area">
          <div className="auth-card">
            ...
            <div className="logo-container">
              {/* This is the closest glyph approximation I can make in SVG */}
            ...
            <form className="login-form" onSubmit={handleLogin} autoComplete="off">
              ...
              <div className="form-actions">
                <a href="#" onClick={(e) => { e.preventDefault(); alert("Password reset link sent to your email!"); }} className="forgot-password">Forgot password?</a>
              </div>
            ...
            <button type="button" disabled={isLoading} onClick={handleGoogleLogin} className="google-button">
